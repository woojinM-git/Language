...
// console.log(testFunction() === global); // true = 일반 함수에서 this는 global을 가리키므로 true
...
// call = name, x, y, z 식으로 나열
console.log(multiply.apply(yuJin3, [3, 4, 5]));
// apply = name, [x, y, z] 식으로 나열

/**
 * bind()
 * 
 * this를 bind 해놓고 나중에 실행 가능
 */
const laterFunc = multiply.bind(yuJin3, 3, 4, 5);
console.log(laterFunc); // [Function: bound multiply] // multiply라는 함수이다
