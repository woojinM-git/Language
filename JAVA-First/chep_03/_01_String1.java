...
public class _01_String1 {
    public static void main(String[] args) {
        ...
        System.out.println(s.lastIndexOf("and")); // 마지막 위치하는 위치정보 (23)
        System.out.println(s.startsWith("I like")); // 이 문자열로 시작하면 true 거짓이면 false
        System.out.println(s.endsWith(".")); // 이 문자열로 끝나면 true 거짓이면 false
    }
}